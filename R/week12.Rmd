...
# Comment:
adding topics improves cv results but does not improve out-of-sample performance prediction. Both models perform poorly but the tokens plus topics model is slightly worse in the holdout set. CV improvement does not mean it can be generalize to new data.
